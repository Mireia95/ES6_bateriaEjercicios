...
const numberCien = numbers.find((number) => number === 100);
console.log(numberCien); //100
...
console.log(movie); //{ title: 'Origen', stars: 5, date: 2010 }
...
const mutaPorom = mutations.find(
  (mutation) => mutation.name === 'Porompompero'
);
const bestAlien = { ...alienCucu, mutation: mutaPorom.name };

...
for (const user of users) {
  for (const sound in user.favoritesSounds) {
    if (repeatedSound[sound] >= 1) {
      repeatedSound[sound] = repeatedSound[sound] + 1;
    } else {
      repeatedSound[sound] = 1;
    }
  }
}

console.log(repeatedSound); //{ waves: 3, rain: 1, firecamp: 3, shower: 2, train: 2, wind: 1 }
